...
<form action="<?= MAINURL . "home/logincheck"  ?> " method="post" class="flex justify-center flex-col" >
    ...
    <button type="submit" class="px-2 p-1 rounded-md mt-2 font-inter text-xl border-black border-2" >
     login
    </button>
